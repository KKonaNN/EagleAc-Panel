...
, function(e, t, i) {
    ...
    t.wrap = function(e, t) {
        ...
        e.nextSibling ? e.parentNode && e.parentNode.insertBefore(t, e.nextSibling) : e.parentNode && e.parentNode.appendChild(t),
        t.appendChild(e)
    }
    ,
    ...
    ,
    t.strToEl = (n = document.createElement("div"),
    function(e) {
        var t = e.trim();
        n.innerHTML = t;
    ...
    var o = r(i(9))
      ...
      , y = function() {
        function e(t, i) {
            ...
            void 0 === i && (i = {}),
            this.config = s.default.all([l.DEFAULT_CONFIG, e.defaults.options, i], {
            ...
            if (this._isTextElement = u.type === l.TEXT_TYPE,
            ...
            this._baseId = m.generateId(this.passedElement.element, "choices-"),
        ...
        e.prototype.highlightItem = function(e, t) {
            ...
            return this._store.dispatch(d.highlightItem(i, !0)),
            t && this.passedElement.triggerEvent(l.EVENTS.highlightItem, {
                id: i,
                value: s,
                label: c,
        ...
        e.prototype.unhighlightItem = function(e) {
            ...
            return this._store.dispatch(d.highlightItem(t, !1)),
        ...
        e.prototype.setChoices = function(e, t, i, n) {
            ...
            "function" == typeof e) {
                ...
                if (!Array.isArray(o))
                    throw new TypeError(".setChoices first argument function must return either array of choices or Promise, got: " + typeof o);
        ...
        e.prototype.clearChoices = function() {
            return this._store.dispatch(h.clearChoices()),
            this
        }
        ,
        e.prototype.clearStore = function() {
            return this._store.dispatch(f.clearAll()),
            this
        }
        ,
            ...
            if (e && t) {
                ...
                if (n) {
                    ...
                    !n.selected && !n.disabled)
                        this._canAddItem(e, n.value).response && (this._addItem({
                            value: n.value,
                            label: n.label,
                            choiceId: n.id,
                            groupId: n.groupId,
                        ...
                        this._triggerChange(n.value));
                    this.clearInput(),
                    o && this._isSelectOneElement && (this.hideDropdown(!0),
        ...
        e.prototype._onKeyUp = function(e) {
            ...
            if (this._isTextElement) {
                ...
                u && d ? (this._isSearching = !1,
                this._store.dispatch(h.activateChoices(!0))) : p && this._handleSearch(this.input.value)
            }
            this._canSearch = this.config.searchEnabled
        }
        ,
        ...
        e.prototype._onEnterKey = function(e, t, i) {
            ...
            if (o && (this._handleButtonAction(t, n),
            e.preventDefault()),
            i) {
        ...
        e.prototype._onDirectionKey = function(e, t) {
            ...
            if (t || this._isSelectOneElement) {
                ...
                var a = i === r || i === s ? 1 : -1
                  , c = void 0;
                if (n || i === s || i === o)
                    c = a > 0 ? this.dropdown.element.querySelector("[data-choice-selectable]:last-of-type") : this.dropdown.element.querySelector("[data-choice-selectable]");
                else {
        ...
        e.prototype._removeItem = function(e) {
            ...
            t && o && (this._store.dispatch(d.removeItem(t, o)),
...
, function(e, t, i) {
            ...
            (i = [{
                ...
                value: function() {
                    ...
                    if (this.options.tokenize)
                        for (var i = e.split(this.options.tokenSeparator), n = 0, r = i.length; n < r; n += 1)
                ...
                value: function(e, t) {
                    ...
                    if (null != o) {
                        ...
                        if ("string" == typeof o) {
                            this._log("\nKey: ".concat("" === i ? "-" : i));
                            var b = d.search(o);
                            if (this._log('Full text: "'.concat(o, '", score: ').concat(b.score)),
                                ...
                                for (var E = o.split(this.options.tokenSeparator), S = [], I = 0; I < u.length; I += 1) {
                                    ...
                                    for (var C = !1, T = 0; T < E.length; T += 1) {
                                        var w = E[T]
                                          , A = O.search(w)
                                          , L = {};
                                        A.isMatch ? (L[w] = A.score,
                                        _ = !0,
                                        C = !0,
                                        S.push(A.score)) : (L[w] = 1,
                ...
                value: function(e, t) {
                    ...
                    for (var i = 0, n = t.length; i < n; i += 1) {
                        for (var r = t[i].output, o = r.length, s = 1, a = 1, c = 0; c < o; c += 1) {
                            ...
                            1 !== l ? a = Math.min(a, u) : (r[c].nScore = u,
                            s *= u)
                        }
                        t[i].score = 1 === a ? s : a,
                        this._log(t[i])
                    ...
                    this.options.includeMatches && r.push((function(e, t) {
                        ...
                        for (var n = 0, r = i.length; n < r; n += 1) {
                            ...
                            if (0 !== o.matchedIndices.length) {
                                ...
                                o.key && (s.key = o.key),
                                o.hasOwnProperty("arrayIndex") && o.arrayIndex > -1 && (s.arrayIndex = o.arrayIndex),
                                t.matches.push(s)
                            }
                        }
                    }
    ...
    , function(e, t, i) {
        ...
        e.exports = function(e, t, i, o) {
            for (var s = o.location, a = void 0 === s ? 0 : s, c = o.distance, l = void 0 === c ? 100 : c, u = o.threshold, h = void 0 === u ? .6 : u, d = o.findAllMatches, p = void 0 !== d && d, f = o.minMatchCharLength, m = void 0 === f ? 1 : f, v = a, _ = e.length, g = h, y = e.indexOf(t, v), b = t.length, E = [], S = 0; S < _; S += 1)
                E[S] = 0;
            if (-1 !== y) {
                var I = n(t, {
                    errors: 0,
    ...
    , function(e, t) {
        e.exports = function() {
            ...
            return e[o - 1] && o - n >= t && i.push([n, o - 1]),
            i
        }
    }
    , function(e, t) {
...
, function(e, t, i) {
    ...
    function o(e, t) {
        return !1 !== t.clone && t.isMergeableObject(e) ? l((i = e,
...
, function(e, t, i) {
    ...
    t.default = function(e, i) {
        ...
        case "HIGHLIGHT_ITEM":
            ...
            return e.map((function(e) {
                var t = e;
                return t.id === o.id && (t.highlighted = o.highlighted),
                t
            }
            ));
        default:
    ...
    t.default = function(e, i) {
        ...
        case "ADD_ITEM":
            ...
            return s.choiceId > -1 ? e.map((function(e) {
                var t = e;
                return t.id === parseInt("" + s.choiceId, 10) && (t.selected = !0),
                t
            }
            )) : e;
        case "REMOVE_ITEM":
            ...
            return a.choiceId && a.choiceId > -1 ? e.map((function(e) {
                var t = e;
                return t.id === parseInt("" + a.choiceId, 10) && (t.selected = !1),
                t
            }
            )) : e;
        case "FILTER_CHOICES":
      ...
      , r = function() {
        ...
        e.prototype._animateScroll = function(e, t) {
            var i = this
              ...
              , s = !1;
            t > 0 ? (this._scrollDown(o, r, e),
            o < e && (s = !0)) : (this._scrollUp(o, r, e),
            o > e && (s = !0)),
...
, function(e, t, i) {
    ...
    var n = {
        containerOuter: function(e, t, i, n, r, o) {
            ...
            return a.dataset.type = o,
            t && (a.dir = t),
            n && (a.tabIndex = 0),
            i && (a.setAttribute("role", r ? "combobox" : "listbox"),
        ...
        choice: function(e, t, i) {
            ...
            _.setAttribute("aria-disabled", "true")) : (_.classList.add(o),
        ...
        notice: function(e, t, i) {
            ...
            void 0 === i && (i = "");
            var a = [n, r];
            return "no-choices" === i ? a.push(s) : "no-results" === i && a.push(o),
        ...
        option: function(e) {
            ...
            return n && (s.dataset.customProperties = "" + n),
            s.disabled = !!o,
            s
        }
    };
